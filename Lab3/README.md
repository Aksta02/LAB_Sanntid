...
Når det kommer til Shortest remeining time så antar vi at den starter først på den første, med en gang det kommer inn med mindre verdi enn det som er igjenn av den første kjøres den, og så gjøres dette konstant slik at den fort kan bytte mellom mange tasks basert på hvem som har minst tid igjenn.

Feedback er basert på hvem som har best feedback
